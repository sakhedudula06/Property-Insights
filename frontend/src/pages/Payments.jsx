            ...
            <dialog id="my_modal_1" className="modal">
              <div className="modal-box bg-white">
                <form onSubmit={handleRegister}>
                  ...
                  <div className='border-2 p-4 rounded-lg flex gap-7 mb-12'>
                    <input type='number' step='0.01' min='0' name='Amount' placeholder='0.00' value={amountValue} onChange={(e) => setAmountValue(e.target.value)} className='w-full h-full text-[rgb(161,161,161)] border-none focus:outline-none' required>
                    </input>
                  </div>

                  <p className='font-bold text-xl mb-5'>Tenant</p>
                  <select className="select w-full max-w-max" value={selectedTenant} onChange={handleSelectedTenant} required>

                    <option>Tenants</option>
                    {tenantsData && tenantsData.map(tenants => (
                  ...
                  <select className="select w-full max-w-max" value={selectedProp} onChange={handleSelectedProp} required>
                  ...
                  <div className='border-2 p-4 rounded-lg flex gap-7 mb-12'>
                    <input
                      ...
                      className='w-full h-full text-[rgb(161,161,161)] border-none focus:outline-none' required
                    />
